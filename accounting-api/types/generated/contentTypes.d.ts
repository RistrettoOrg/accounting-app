...
export interface ApiJournalEntryJournalEntry
  ...
  attributes: {
    ...
    journal_lines: Schema.Attribute.Relation<
      'oneToMany',
      'api::journal-line.journal-line'
    > &
...
export interface ApiJournalLineJournalLine extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::journal-line.journal-line': ApiJournalLineJournalLine;
